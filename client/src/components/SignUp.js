...
import { Breadcrumb, Card, Col, Form, Row, Button } from 'react-bootstrap';
        ...
        {({
          ...
          <Form noValidate onSubmit={handleSubmit}>
            <Form.Group controlId='username'>
                    ...
                    <Form.Control className={'username' in errors ? 'is-invalid' : ''} name='username' onChange={handleChange} values={values.username} />
                    {
                      'username' in errors &&
...
<Form.Group controlId='photo'>
  ...
  />
  {
    ...
    <Form.Control.Feedback type='invalid'>{ errors.photo }</Form.Control.Feedback>
              ...
              <Button block type='submit' variant='primary' className='mx-4 mt-5'>Sign up</Button>
          </Form>
        )}
      </Formik>
